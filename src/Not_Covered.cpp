...
unsigned int crc32_4(unsigned char *message) {
   int i, j;
...
unsigned int crc32_3(unsigned char *message) {
   int i, j;
   unsigned int byte, crc, mask;
...
unsigned int crc32_2(unsigned char *message) {
   int i, j;
   unsigned int byte, crc, mask;
...
unsigned int crc32_1(unsigned char *message) {
   int i, j;
   unsigned int byte, crc, mask;
